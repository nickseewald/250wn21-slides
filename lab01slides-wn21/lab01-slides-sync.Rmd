...
## Lab attendance
- It's expected that you attend these syncrhonous lab sessions and participate in the collaborative breakout sessions. 
  - Please do not leave when breakout rooms open! 
- If you can't make it to a syncrhonous session in a particular week, you *must* email me to get asynchronous materials. 
...
- **Tutorial** (~30 minutes): We'll walk through how to perform tasks in R together
  - iClicker engagement questions sprinkled throughout (not graded, just for fun)
...
# `r emo::ji("inbox_tray")` Lab Submission: Canvas (Due 1/29 8a ET)
